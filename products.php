...
<html>
    <head>
        <title>Pet products project</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <img src="https://wallpapercave.com/wp/wp2544022.jpg" style="postion:relative;height:80%;width:100%;">
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img\4.jpg" alt="Dog food" width="1813" height="2560">
                                <!-- <div class="overlay">
                                  <div class="text">Dog food</div>
                                </div> -->
                            <center>
                                <div class="caption">
                                    <h3>Dog food</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img\3.jpg" alt="Dog tooth brush" width="1813" height="2560">
                            <center>
                                <div class="caption">
                                    <h3>Dog tooth brush</h3>
                                    <p>Price: Rs. 400.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img\2.jpg" alt="Dog coat scrubber" >
                            <center>
                                <div class="caption">
                                    <h3>Dog coat scrubber</h3>
                                    <p>Price: Rs. 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img\7.jpg" alt="Dog nail cutter">
                            <center>
                                <div class="caption">
                                    <h3>Dog nail cutter</h3>
                                    <p>Price: Rs. 80.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img\shampoo.jpg" alt="Puppy shampoo">
                            <center>
                                <div class="caption">
                                    <h3>Puppy shampoo</h3>
                                    <p>Price: Rs. 800.00</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img\1.jpg" alt="Dentastix">
                            <center>
                                <div class="caption">
                                    <h3>Dentastix</h3>
                                    <p>Price: Rs. 500.00</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img\6.jpg" alt="In home trainers">
                            <center>
                                <div class="caption">
                                    <h3>In home trainers</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                                <img src="img\5.jpg" alt="veterinarian">
                            <center>
                                <div class="caption">
                                    <h3>veterinarian</h3>
